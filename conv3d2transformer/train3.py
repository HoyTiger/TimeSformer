...
flag = 1
His = {'val_mae':[]}
Model = CAN(n_frame, nb_filters1, nb_filters2, input_shape_1)
...
for train_index,vali_index in kf.split(sample_list):
    ...
    checkpoint = ModelCheckpoint(filepath='./ZZ-cv'+str(flag)+'-{epoch:02d}-{loss:.2f}.hdf5',\
                                 monitor='val_loss',
